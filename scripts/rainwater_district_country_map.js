...
var tooltip = d3.select("#scene5_district_country_map").append("div")
  .attr("class", "tooltip")
  .style("opacity", 0);

var svg = d3.select("#scene5_district_country_map")
            .append("svg")                
                .attr("width",WD)
                .attr("height",HT)
...
var promises = [
    ...
    d3.csv("data/district_rainfall_2021.csv",  function(d) {
      ...
      // rainwater_dist_status.set(d.DISTRICT_CODE, d.Annual); 
...
tooltip_div.html("<span>District: " + d.properties.district + "<br/>" 
  ...
  + "Rainfall Status: " + rain_dist_status.get(d.properties.dt_code) + "<br /></span>") 
  // + "Annual Rainfall:" + rain_dist_recorded.get(d.properties.dt_code)+ "<br /></span>")
